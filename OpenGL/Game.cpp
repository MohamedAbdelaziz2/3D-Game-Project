...
void Game::initShaders()
{
	this->shaders.push_back(new Shader(this->GL_VERSION_MAJOR, this->GL_VERSION_MINOR,
		"VertexCore.glsl", "FragmentCore.glsl"));
}
...
void Game::initTextures()
{
	...
	//TEXTURE 1
	this->textures.push_back(new Texture("Images/ZomboBake4.png", GL_TEXTURE_2D));
	this->textures.push_back(new Texture("Images/ZomboBake4.png", GL_TEXTURE_2D));
...
void Game::initMaterials()
{
	this->materials.push_back(new Material(glm::vec3(0.1f), glm::vec3(1.f), glm::vec3(1.f),
		0, 1));
	this->materials.push_back(new Material(glm::vec3(0.3f), glm::vec3(1.5f), glm::vec3(1.5f),
		0, 1));
}
...
void Game::initModels()
{
	...
	this->models.push_back(new Model(
		glm::vec3(10.f, -4.5f, 3.f),
		this->materials[1],
		this->textures[TEX_CONTAINER],
		this->textures[TEX_CONTAINER_SPECULAR],
		"Objects/ZomboAnimated.obj"
	)
	);
	this->models.push_back(new Model(
		glm::vec3(1.f, -4.5f, 1.f),
		this->materials[0],
		this->textures[SPACESHIP_TEX],
		this->textures[SPACESHIP_TEX],
		"Objects/SpaceTri2.obj"
	)
	);
	
	this->models[0]->rotate(glm::vec3(0.f, -90.f, 0.f));
	...
	this->models.push_back(new Model(
		glm::vec3(2.f, -5.f, 2.f), //Ground
		this->materials[1],
		this->textures[GROUND_TEX],
		this->textures[GROUND_TEX],
		meshes2
	)
	);
...
Game::Game(
	...
	camera(glm::vec3(10.f, -3.f, 4.f), glm::vec3(0.f, 0.f, 1.f), glm::vec3(0.f, 1.f, 0.f))
{
	//Init variables
	this->window = nullptr;
...
void Game::updateKeyboardInput()
{
	...
	if (glfwGetKey(this->window, GLFW_KEY_W) == GLFW_PRESS)
	{
		...
		this->models[0]->move(glm::vec3(0.f, 0.f, 0.0125f));
	...
	if (glfwGetKey(this->window, GLFW_KEY_A) == GLFW_PRESS)
	{
		...
		this->models[0]->move(glm::vec3(0.0125f, 0.f, -0.00045f));
...
void Game::updateInput()
{
	...
	glm::mat4 newPos = this->camera.getViewMatrix();
}
